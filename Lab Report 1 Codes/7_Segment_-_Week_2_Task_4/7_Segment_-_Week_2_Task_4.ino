// The goal of this program is to use arrays to display numbers 0 - 9 by declaring declaring them in a function that is used in the loop e.g zero(); displays 0 in the 7-segment.
...
void loop() {
  ...
  one();        // Uses function "one" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  two();        // Uses function "two" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  three();      // Uses function "three" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  four();       // Uses function "four" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  five();       // Uses function "five" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  six();        // Uses function "six" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  seven();      // Uses function "seven" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  eight();      // Uses function "eight" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms

  nine();       // Uses function "nine" to display 0 in the 7-segment
  delay(time);  // Delay "time" for 500 ms
}
